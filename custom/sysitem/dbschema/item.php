...
return  array(
    'columns'=> array(
       ...
       // ),
        ...
        //2016.7.20 hui增加了商品来源和商品来源链接字段
        'source' => array(
            'type' => 'string',
            'required' => true,
            'default' => '',
            'label' => app::get('sysitem')->_('商品来源'),
            'comment' => app::get('sysitem')->_('商品来源'),
            'in_list' => true,
            'default_in_list' => true,
        ),
        'source_link' => array(
            ...
            'required' => true,
            'default' => '',
            'label' => app::get('sysitem')->_('商品来源链接'),
            'comment' => app::get('sysitem')->_('商品来源链接'),
            'in_list' => true,
            'default_in_list' => true,
        ),
        'keyword' => array(
            ...
            'required' => true,
            'default' => '',
            'label' => app::get('sysitem')->_('商品关键词'),
            'comment' => app::get('sysitem')->_('商品关键词'),
            'in_list' => true,
            'default_in_list' => true,
        ),
        'hash' => array(
            'type' => 'string',
            'label' => app::get('sysitem')->_('hash值'),
        ),
        //--------------------------------------------------
    ),
    'primary' => 'item_id',
