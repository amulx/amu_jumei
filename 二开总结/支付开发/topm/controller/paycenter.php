...
class topm_ctl_paycenter extends topm_controller{
    ...
    public function index($filter=null)
    {
        ...
        //var_dump('topm_ctl_paycenter.index:' .json_encode($payments));
        ...
        //{
        //    var_dump('topm_ctl_paycenter.index:' .$payment['app_display_name'] .',app_id:' .$payment['app_id']);
        //}
        //var_dump('topm_ctl_paycenter.index:' .json_encode($newtrade));
        $pagedata['tids'] = $tids['tid'];
        $pagedata['trades'] = $paymentBill;
        $pagedata['payments'] = $payments;
        $pagedata['newtrade'] = $newtrade;
        $pagedata['mainfile'] = "topm/payment/payment.html";
    ...
    public function dopayment()
    {
        ...
        //var_dump('dopayment:' .json_encode($payment));
        //exit();
    ...
    public function finish()
    {
        ...
        //var_dump('topm_ctl_paycenter.finish:' .json_encode($pagedata));
        if ($result['pay_app_id'] == 'remittance')
        {
            // 线下汇款
            return $this->page('topm/payment/reittance.html', $pagedata);
        }
        else
        {
